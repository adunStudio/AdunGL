...
void Test3D::onInit(Renderer3D& renderer, Scene& scene)
{
	...
	Model* sphere = new Model("MyGame/Asset/Objs/sphere.obj", new MaterialInstance(m_material));
...
void Test3D::onUpdate()
{
	...
	//mat4 transform = mat4::rotation(m_rotation, vec3(1, 0, 0)) * mat4::rotation(m_rotation, vec3(0, 1, 0)) * mat4::rotation(m_rotation, vec3(0, 0, 1));
